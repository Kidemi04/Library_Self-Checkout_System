  ...
  return (
    <main className="space-y-8">
      ...
      <section className="space-y-6">
        ...
        <div className="rounded-2xl border border-swin-charcoal/10 bg-white p-6 shadow-md dark:border-slate-700 dark:bg-slate-900/80 dark:text-slate-100">
          <h3 className="text-lg font-semibold text-swin-charcoal dark:text-slate-100">Kenneth Hui Hong CHUA</h3>
          <p className="text-sm text-swin-charcoal/80 mt-1 dark:text-slate-300">
            Bachelor of Computer Science (Artificial Intelligence)
          </p>
          <p className="text-sm text-swin-charcoal/80 mt-1 dark:text-slate-300">
            Student ID: 102782494
          </p>
          <p className="text-sm text-swin-charcoal/60 mt-2 dark:text-slate-400">
            <span className="font-medium">Email:</span>{" "}
            <a
              href="mailto:102782494@students.swinburne.edu.my"
              className="text-swin-red hover:underline dark:text-emerald-300"
            >
       ...
       <div className="rounded-2xl border border-swin-charcoal/10 bg-white p-6 shadow-md dark:border-slate-700 dark:bg-slate-900/80 dark:text-slate-100">
          <h3 className="text-lg font-semibold text-swin-charcoal dark:text-slate-100">Kelvin Wen Kiong FONG</h3>
          <p className="text-sm text-swin-charcoal/80 mt-1 dark:text-slate-300">
            Bachelor of Computer Science (Artificial Intelligence)
          </p>
          <p className="text-sm text-swin-charcoal/80 mt-1 dark:text-slate-300">
        ...
        <div className="rounded-2xl border border-swin-charcoal/10 bg-white p-6 shadow-md dark:border-slate-700 dark:bg-slate-900/80 dark:text-slate-100">
          <h3 className="text-lg font-semibold text-swin-charcoal dark:text-slate-100">Nigel Zi Jun LING</h3>
          <p className="text-sm text-swin-charcoal/80 mt-1 dark:text-slate-300">
            Bachelor of Computer Science (Artificial Intelligence)
          </p>
          <p className="text-sm text-swin-charcoal/80 mt-1 dark:text-slate-300">
        ...
        <div className="rounded-2xl border border-swin-charcoal/10 bg-white p-6 shadow-md dark:border-slate-700 dark:bg-slate-900/80 dark:text-slate-100">
          <h3 className="text-lg font-semibold text-swin-charcoal dark:text-slate-100">Enoch Eren CHUA</h3>
          <p className="text-sm text-swin-charcoal/80 mt-1 dark:text-slate-300">
            Bachelor of Computer Science (Artificial Intelligence)
          </p>
          <p className="text-sm text-swin-charcoal/80 mt-1 dark:text-slate-300">
        ...
        <div className="rounded-2xl border border-swin-charcoal/10 bg-white p-6 shadow-md dark:border-slate-700 dark:bg-slate-900/80 dark:text-slate-100">
          <h3 className="text-lg font-semibold text-swin-charcoal dark:text-slate-100">Ivan Jia Wei HOAN</h3>
          <p className="text-sm text-swin-charcoal/80 mt-1 dark:text-slate-300">
      ...
      <section className="space-y-4">
        ...
        <div className="rounded-2xl bg-swin-ivory p-6 shadow-md border border-swin-charcoal/10 dark:border-slate-700 dark:bg-slate-900/80 dark:text-slate-200 dark:shadow-black/20">
          <p className="text-swin-charcoal/80 dark:text-slate-200">
            For any library queries, please get in touch with library staff or
            reach out through the following channels:
          </p>

          <ul className="mt-4 space-y-2 text-swin-charcoal/80 dark:text-slate-200">
            <li>
              <strong>Email:</strong>{" "}
              <a
          ...
          <div className="mt-6">
            <p className="font-semibold text-swin-charcoal dark:text-slate-100">Follow us:</p>
