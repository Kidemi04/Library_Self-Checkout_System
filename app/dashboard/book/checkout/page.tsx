...
export default async function BorrowBooksPage({
  ...
  const [books, activeLoans] = await Promise.all([
    ...
    fetchActiveLoans(undefined, !canProcessLoans && user ? user.id : undefined),
  ]);
