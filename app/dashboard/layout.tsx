...
export default async function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    ...
    >
      <aside className="hidden md:flex md:w-72 md:flex-none md:flex-col md:px-4 md:py-6">
      ...
      <div className="flex min-h-screen w-full flex-col">
        ...
        <div
          className={clsx(
            'flex-1 overflow-y-auto px-4 py-6 sm:px-6 md:px-12 md:py-10 rounded-2xl shadow-inner shadow-black/20',
            isStaff
