...
function SkeletonLine({ width = 'w-full', height = 'h-4' }: { width?: string; height?: string }) {
  return (
    <div className={`${shimmer} relative overflow-hidden rounded-md bg-slate-200 dark:bg-slate-700 ${height} ${width}`} />
  );
}

function SkeletonCard() {
  return (
    <div className={`${shimmer} relative overflow-hidden rounded-2xl bg-slate-100 dark:bg-slate-800 p-5 flex flex-col gap-3`}>
...
function SkeletonRow() {
  return (
    <div className="flex items-center gap-4 py-3 border-b border-slate-100 dark:border-slate-800">
      <div className={`${shimmer} relative overflow-hidden rounded-full bg-slate-200 dark:bg-slate-700 h-10 w-10 shrink-0`} />
...
export default function PageLoadingSkeleton() {
  return (
    <div className="animate-pulse space-y-6 p-4 md:p-6">
      ...
      {/* Content rows */}
      <div className={`${shimmer} relative overflow-hidden rounded-2xl bg-slate-100 dark:bg-slate-800 p-4`}>
        <SkeletonRow />
        <SkeletonRow />
        <SkeletonRow />
        <SkeletonRow />
